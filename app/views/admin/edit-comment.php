            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-field">
                        ...
                        <input type="text" id="author" name="author" value="<?php echo escape(ucwords($data['selectedComment']['pc_author'])) ?>" autocomplete="off">
                    </div>
                    ...
                    <div class="form-field">
                        <label for="post_text">Comment Body</label>
