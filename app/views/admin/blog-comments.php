    ...
    <div class="container">
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($data['comments'] as $comment) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="template-btn" href="<?php echo ROOT . $subName . '-edit/' . escape($data['selectedPost']['p_id']) . '/' . escape($comment['pc_id']) ?>">Edit</a>
                                </td>
                                <td>
                                    <a class="template-btn" href="<?php echo ROOT . $subName . '-delete/' . escape($data['selectedPost']['p_id']) . '/' . escape($comment['pc_id']) ?>">Remove</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
        ...
        <div class="row">
            <div class="col-lg-12 admin-navigate-buttons">
                <div>
                    <a class="template-btn" href="<?php echo ROOT .  'admin-blog/edit/' . escape($data['selectedPost']['p_id']) ?>">Back to Post</a>
                </div>
            </div>
        </div>
    </div>
