        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="categories_post">
                    <img src="<?php echo DIST ?>img/blog/cat-post/cat-post-3.jpg" alt="post">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="categories_post">
                    <img src="<?php echo DIST ?>img/blog/cat-post/cat-post-2.jpg" alt="post">
                    <div class="categories_details">
                        <div class="categories_text">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="categories_post">
                    <img src="<?php echo DIST ?>img/blog/cat-post/cat-post-1.jpg" alt="post">
                    <div class="categories_details">
                        <div class="categories_text">
                            <a href="#"><h5>Food</h5></a>
                            <div class="border_line"></div>
            ...
            <div class="col-lg-8">
                <div class="blog_left_sidebar">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="<?php echo DIST ?>img/blog/main-blog/m-blog-2.jpg" alt="">
                                <div class="blog_details">
                                    <a href="#"><h4>The Basics Of Buying A Telescope</h4></a>
                                    <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                    <a href="#" class="template-btn">View More</a>
                                </div>
                            </div>
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="<?php echo DIST ?>img/blog/main-blog/m-blog-3.jpg" alt="">
                                <div class="blog_details">
                                    <a href="#"><h4>The Glossary Of Telescopes</h4></a>
                                    <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                    <a href="#" class="template-btn">View More</a>
                                </div>
                            </div>
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="<?php echo DIST ?>img/blog/main-blog/m-blog-4.jpg" alt="">
                                <div class="blog_details">
                                    <a href="#"><h4>The Night Sky</h4></a>
                                    <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                    <a href="#" class="template-btn">View More</a>
                                </div>
                            </div>
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="<?php echo DIST ?>img/blog/main-blog/m-blog-5.jpg" alt="">
                                <div class="blog_details">
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget author_widget">
                        <img class="author_img rounded-circle" src="<?php echo DIST ?>img/blog/author.png" alt="">
                    ...
                    <aside class="single_sidebar_widget ads_widget">
                        <a href="#"><img class="img-fluid" src="<?php echo DIST ?>img/blog/add.jpg" alt=""></a>
                        <div class="br"></div>
                    </aside>
